 ...
 */
void logger_set_level(enum log_level level) { _level = level; }
 ...
 * @return enum Level
 */
enum log_level logger_get_level(void) { return _level; }
 ...
 */
void logger_out(const enum log_level level, const char *func, const int line,
                const char *fmt, ...) {
  char buffer[1000];
  va_list args;
